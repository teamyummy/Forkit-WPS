...
urlpatterns = [
    ...
    url(r'^v1/users/(?P<pk>[0-9]+)/$', m_apis.UserDetail.as_view(), name='user-detail'),

    url(r'^v1/restaurants/$', d_apis.RestaurantList.as_view(), name='restaurant-list'),
    url(r'^v1/restaurants/(?P<pk>\d+)/$', d_apis.RestaurantDetail.as_view(), name='restaurant-detail'),

    url(r'^v1/restaurants/(?P<rest_id>\d+)/menus/$', d_apis.MenuList.as_view(), name='menu-list'),
    url(r'^v1/restaurants/(?P<rest_id>\d+)/menus/(?P<pk>\d+)/$', d_apis.MenuDetail.as_view(), name='menu-detail'),
    ...
    url(r'^v1/restaurants/(?P<rest_id>\d+)/favors/(?P<pk>\d+)/$',
        d_apis.FavorList.as_view(), name='rest-favor-detail'),

    # url(r'^v1/menus/$', d_apis.MenuList.as_view(), name='menu-list'),
    # url(r'^v1/menus/(?P<pk>[0-9]+)/$', d_apis.MenuDetail.as_view(), name='menu-detail'),
]
